<?php
$recipient_email    = "encomendas@thefamilycakes.com"; //recepient
$from_email         = "encomendas@thefamilycakes.com"; //from email using site domain.
...
if($_POST){
    ...
    $sender_email   = filter_var($_POST["usermail"], FILTER_SANITIZE_STRING); //capture sender email
    $phone_number   = filter_var($_POST["userphone"], FILTER_SANITIZE_NUMBER_INT);
    $subject        = "Encomenda";
    $message        = filter_var($_POST["orderMessage"], FILTER_SANITIZE_STRING); //capture message

    $attachments = $_FILES['filesData'];
    ...
    $boundary = md5("thefamilycakes.com"); 
